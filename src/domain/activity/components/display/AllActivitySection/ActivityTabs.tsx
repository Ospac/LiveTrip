...
import { categoryTabs } from '@/domain/activity/components/display/AllActivitySection/CategoryTabs';
...
const _BUTTON_DEFAULT_CLASS_NAME =
  'border-gray-150 hover:bg-gray-25 flex-center min-w-fit cursor-pointer gap-1.5 rounded-[100px] border-1 px-4 py-2.5 active:bg-gray-900 active:text-white active:[&_svg]:fill-white bg-white';
